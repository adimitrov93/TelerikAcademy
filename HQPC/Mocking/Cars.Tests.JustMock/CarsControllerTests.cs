namespace Cars.Tests.JustMock
{
    ...
    public class CarsControllerTests
    {
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void DetailsShoudThrowAnExceptionIfGetByIdReturnsNull()
        {
            var model = (Car)this.GetModel(() => this.controller.Details(1));
        }

        [TestMethod]
        public void SearchingACarMustReturnAllCarsWithMakeBmw()
        {
        ...
        [TestMethod]
        public void SortingCarsByMakeMustReturnAllCars()
        {
        ...
        [TestMethod]
        public void SortingCarsByYearMustReturnAllCars()
        {
        ...
        public void SortingCarsByInvalidPropertyMustThrowAnException()
        {
