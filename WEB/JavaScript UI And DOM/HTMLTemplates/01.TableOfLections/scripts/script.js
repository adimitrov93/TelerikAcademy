window.onload = function () {
    ...
    var lectionsListContainer = document.getElementById('container');

    var lectionsListTemplate = Handlebars.compile((document.getElementById('lections-template')).innerHTML);

    lectionsListContainer.innerHTML = lectionsListTemplate({
        lections: lections
    });
};